    ...
    return (
        <>
            <div>
                    ...
                    <Button variant="dark" style={{ borderRadius: 0, width:'20%', alignItems: 'center', marginBottom:'10px' }}> Add Cart <img src={cart} style={{marginBottom:'2px', marginLeft:'2px'}} alt="" /></Button>
                    </div>
                    </Col>
                    </Row>
                        </div>
